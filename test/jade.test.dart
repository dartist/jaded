...
subGroup(String groupName, String testName, List<dynamic> list,
    {bool doctype = false, bool reason = false, locals = false}) {
...
main() {
  String __dirname = ".";
  String perfTest = File(__dirname + '/fixtures/perf.jade').readAsStringSync();

  runGroups(int groupNo, a, fn) {
    switch (groupNo) {
      case 0:

...
Map<String, Function> JADE_TEMPLATES = {
  'files/views/sub/app-layout.jade': ([locals]) {
    ...
    if (self == null) self = {};
    buf.add(
        "<html><script src=\"vendor/jquery.js\"></script><script src=\"vendor/caustic.js\"></script><script src=\"app.js\"></script><body></body></html>");
    ;
    return buf.join('');
  },
          ...
          for (var $index = 0, $$l = $$obj.length; $index < $$l; $index++) {
            ...
            if ((item.parent != null)) {
              buf.add("<div><li" +
                  ...
                  "><a" +
                  (jade.attrs({'href': ('/admin/report/detail/' + item.id)},
                      {"href": true})) +
                  ">" +
                  (jade.escape(
                      null == (jade.interp = item.name) ? "" : jade.interp)) +
                  "</a></li>");
              chp = item.id;
              {
                        ...
                        if ((item.parent == chp && item.type == 'section')) {
                          buf.add("<div><li" +
                              ...
                              (jade.attrs(
                                  ...
                                  {"href": true})) +
                              ">" +
                              (jade.escape(null == (jade.interp = item.name)
                                  ? ""
                                  : jade.interp)) +
                              "</a></li>");
                          sec = item.id;
...
// iterate report
  ...
  'files/views/sub/sub2/scripts.jade': ([locals]) {
    ...
    if (self == null) self = {};
    buf.add(
        "<script src=\"/jquery.js\"></script><script src=\"/caustic.js\"></script>");
    ;
    return buf.join('');
  },
  ...
  'files/views/sub/layout.jade': ([locals]) {
    ...
    if (self == null) self = {};
    buf.add(
        "<html><script src=\"vendor/jquery.js\"></script><script src=\"vendor/caustic.js\"></script><body></body></html>");
    ;
    return buf.join('');
  },

...
'files/views/sub/app-layout.jade': ([Map locals]){///jade-begin
...
'files/views/sub/page.jade': ([Map locals]){///jade-begin
  if (locals == null) locals = {};
...
'files/views/sub/sub2/perf.jade': ([Map locals]){///jade-begin
  if (locals == null) locals = {};
...
'files/views/sub/sub2/scripts.jade': ([Map locals]){///jade-begin
  if (locals == null) locals = {};
...
'files/views/sub/layout.jade': ([Map locals]){///jade-begin
  if (locals == null) locals = {};
...
'files/views/index.jade': ([Map locals]){///jade-begin
  if (locals == null) locals = {};
...
'files/views/layout.jade': ([Map locals]){///jade-begin
  if (locals == null) locals = {};
  var title = locals['title'];
